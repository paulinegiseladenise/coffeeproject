...
//attachToRoot var satt till true, därav funkade det inte riktigt att navigera....
    override fun onCreateView(
        ...
        view.setOnClickListener(){
            Navigation.findNavController(view).navigate(R.id.action_countdownFragment_to_resultFragment)
        }
        return view
